...
public class ScraperSteps {
    ...
    public void i_search_for_tshirts(String brand) {
        page.fill("input[placeholder='Search for products, brands and more']", brand + " T-shirts Men");
    ...
    public void extractDiscountedData() {
        ...
        for (int i = 0; i < tshirts.count(); i++) {
            ...
            if (!discount.isEmpty() && Integer.parseInt(discount) > 100) {
                System.out.println("Skipping product - Not a percentage discount: Brand: " + brand + ", Discount: " + discount);
                continue;
            }
